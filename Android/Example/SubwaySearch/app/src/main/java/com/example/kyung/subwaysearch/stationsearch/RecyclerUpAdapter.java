...
public class RecyclerUpAdapter extends RecyclerView.Adapter<RecyclerUpAdapter.Holder> {

    FrameLayout frameLayout;
    Context context;
    List<Row> rowList;

    public RecyclerUpAdapter(FrameLayout frameLayout, List<Row> rowList){
        this.frameLayout = frameLayout;
        this.rowList = rowList;
    }

    @Override
    public RecyclerUpAdapter.Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.time_list,parent,false);
        return new Holder(view);
    }

    @Override
    public void onBindViewHolder(RecyclerUpAdapter.Holder holder, int position) {
