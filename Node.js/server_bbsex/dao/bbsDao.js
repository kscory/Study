...
exports.create = function(bbs_insertQuery,callbackResult){
...
exports.update = function(bbs_updateQuery, callbackResult){
    mongo.connect(dburl,function(error,db){
        
    });
};

exports.delete = function(bbs_deleteQuery, callbackResult){
    mongo.connect(dburl,function(error,db){
